...
<?php
	...
	$cat_q = "select * from customers where cus_id = '".$_GET["id"]."'";
	//die($q);
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="box box-primary">
						...
						<h3 class="box-title"><strong>Edit Customers</strong></h3>
					...
					<input type="hidden" name="cus_id" value="<?php echo $row["cus_id"] ?>" />
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									...
									<input type="text" name="name" class="form-control" value="<?php echo $row["cus_name"] ?>">
